<template>
    <div>
        <v-container class="mt-5 ma-3">
              <v-card class="pa-4" outlined v-if="allInfections">
                <v-data-table :headers="headers" :search="search" :items="allInfections" :loading ="loadingData" loading-text="Loading... Please wait">
                    <template v-slot:top>
                    <v-toolbar flat color="white">
                        <v-toolbar-title>Faecal Infection Examination Results</v-toolbar-title>
                    ...
                    <template v-slot:item.firstname="{item}">
                        <span v-if="allInfections" class="caption font-weight-bold">{{item.patient.firstname}} {{item.patient.lastname}}</span>
                    </template>
                    <template v-slot:item.gender="{item}">
                        <span v-if="allInfections" class="caption font-weight-bold">{{item.patient.gender}}</span>
                    </template>
                    <template v-slot:item.dob="{item}">
                        <span v-if="allInfections" class="caption font-weight-bold">{{item.patient.dob | formatDob}}</span>
                    </template>
                    <template v-slot:item.examined="{item}">
                        <span v-if="allInfections" class="caption font-weight-bold">{{item.user.title}} {{item.user.lastname}}, {{item.user.firstname}}</span>
                    </template>
                    <template v-slot:item.created_at="{item}">
                        <span v-if="allInfections" class="caption font-weight-bold">{{item.created_at | formatDate}}</span>
                    </template>
                                    ...
                                    <v-container>
                                        <v-card outlined>
                                            ...
                                            <v-card outlined class="mt-5">
                                                <v-card-title class="subtitle-2">
                                                    <span class="subtitle-2 font-weight-bold text-uppercase">Infection Examination</span>
                                                </v-card-title>
                                                <v-divider />
                                                <v-card-text>
                                                    <v-simple-table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.infection" readonly dense class="subtitle-2 font-weight-bold" ></v-text-field>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.occult_blood" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.bile" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.wbc" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.rbc" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.sugar" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.mucus" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.ph" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
...
export default {
    ...
    computed:{
        ...mapGetters(['allInfections']),
    },
    methods:{
        ...mapActions(['fetchInfections']),
