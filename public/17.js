...
/***/ "./node_modules/kalendar-vue/dist/kalendar-event-165d650e.js":
/*!*******************************************************************!*\
  !*** ./node_modules/kalendar-vue/dist/kalendar-event-165d650e.js ***!
  \*******************************************************************/
...
var script = {
  ...
  computed: {
    isPast: function isPast() {
      var now = Object(_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__["g"])(new Date().toISOString());
      return Object(_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__["f"])(this.event.start.value, now);
    },
    ...
    information: function information() {
      var _this$event = this.event,
          ...
          key = _this$event.key;
      var payload = {
        start_time: Object(_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__["j"])(start.value),
        end_time: Object(_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__["j"])(end.value),
        kalendar_id: id,
        key: key,
        data: data
      };
