<template>
    <v-container>
        ...
        <v-card class="pa-4" outlined>
            <v-card-title>
                <span class="subtitle-1 black--text font-weight-bold">Patient Medical Examination</span> 
            </v-card-title>
            <v-divider />
                                        ...
                                        <template v-slot:item.actions = "{item}">
                                            <v-tooltip top>
                                                <template v-slot:activator="{on}">
                                                    <v-btn class="ma-2" v-on="on" fab dark color="info darken-2" x-small @click="medical_examination(item)">
                                            ...
                                            <v-tooltip top>
                                                <template v-slot:activator="{on}">
                                                    <v-btn class="ma-2" v-on="on" fab dark color="success darken-2" x-small @click="complete_examination(item)">
...
export default {
    ...
    methods:{
        ...
        medical_examination(item){
            this.$router.push({name: 'medical_assessment_details', params: {id: item.id}});
        },
