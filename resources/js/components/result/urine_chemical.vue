<template>
    <div>
        <v-container class="mt-5 ma-3">
              <v-card class="pa-4" outlined v-if="allUrineChemical">
                <v-data-table :headers="headers" :search="search" :items="allUrineChemical" :loading ="loadingData" loading-text="Loading... Please wait">
                    <template v-slot:top>
                    <v-toolbar flat color="white">
                        <v-toolbar-title>Urine Chemical Examination Results</v-toolbar-title>
                    ...
                    <template v-slot:item.firstname="{item}">
                        <span v-if="allUrineChemical" class="caption font-weight-bold">{{item.patient.firstname}} {{item.patient.lastname}}</span>
                    </template>
                    <template v-slot:item.gender="{item}">
                        <span v-if="allUrineChemical" class="caption font-weight-bold">{{item.patient.gender}}</span>
                    </template>
                    <template v-slot:item.dob="{item}">
                        <span v-if="allUrineChemical" class="caption font-weight-bold">{{item.patient.dob | formatDob}}</span>
                    </template>
                    <template v-slot:item.examined="{item}">
                        <span v-if="allUrineChemical" class="caption font-weight-bold">{{item.user.title}} {{item.user.lastname}}, {{item.user.firstname}}</span>
                    </template>
                    <template v-slot:item.created_at="{item}">
                        <span v-if="allUrineChemical" class="caption font-weight-bold">{{item.created_at | formatDate}}</span>
                    </template>
                                        ...
                                        <v-card outlined>
                                            <v-card-title>
                                                <v-row>
                                                    ...
                                                    <v-col cols="6" class="mt-10 text-center">
                                                        ...
                                                        <h5 class="subtitle-2 font-weight-bold text-uppercase">Urine Chemical Examination Test</h5>
                                            ...
                                            <v-card-text>
                                                ...
                                                <v-card outlined class="mt-5">
                                                    <v-card-title class="subtitle-2">
                                                        <span class="subtitle-2 font-weight-bold text-uppercase">Chemical Examination Analysis</span>
                                                    </v-card-title>
                                                    <v-divider />
                                                    <v-card-text>
                                                    <v-form ref="chemical">
                                                                ...
                                                                <thead>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.gravity"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.acidity"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.concentration"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.protein"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.sugar"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.ketones"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.bilirubin"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.nitrites"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.myoglobin"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.leukocyte"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold" readonly v-model="form.ascorbic"></v-text-field>
                                                                            </td>
                                                                            <td>
                                                                                <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                            </td>
...
export default {
    ...
    computed:{
        ...mapGetters(['allUrineChemical']),
    },
    methods:{
        ...mapActions(['fetchUrineChemical']),
