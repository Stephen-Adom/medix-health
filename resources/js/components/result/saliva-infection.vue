<template>
    <div>
        <v-container class="mt-5 ma-3">
              <v-card class="pa-4" outlined v-if="allSalivaInfections">
                <v-data-table :headers="headers" :search="search" :items="allSalivaInfections" :loading ="loadingData" loading-text="Loading... Please wait">
                    <template v-slot:top>
                    <v-toolbar flat color="white">
                        <v-toolbar-title> Infection Examination Analysis</v-toolbar-title>
                    ...
                    <template v-slot:item.firstname="{item}">
                        <span v-if="allSalivaInfections" class="caption font-weight-bold">{{item.patient.firstname}} {{item.patient.lastname}}</span>
                    </template>
                    <template v-slot:item.gender="{item}">
                        <span v-if="allSalivaInfections" class="caption font-weight-bold">{{item.patient.gender}}</span>
                    </template>
                    <template v-slot:item.dob="{item}">
                        <span v-if="allSalivaInfections" class="caption font-weight-bold">{{item.patient.dob | formatDob}}</span>
                    </template>
                    <template v-slot:item.examined="{item}">
                        <span v-if="allSalivaInfections" class="caption font-weight-bold">{{item.user.title}} {{item.user.lastname}}, {{item.user.firstname}}</span>
                    </template>
                    <template v-slot:item.created_at="{item}">
                        <span v-if="allSalivaInfections" class="caption font-weight-bold">{{item.created_at | formatDate}}</span>
                    </template>
                                        ...
                                        <v-card-title>
                                            <v-row>
                                                ...
                                                <v-col cols="6" class="mt-10 text-center">
                                                    ...
                                                    <h5 class="subtitle-2 font-weight-bold text-uppercase">Saliva Infection Examination Test</h5>
                                                    ...
                                                    <v-simple-table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.hiv" readonly dense class="subtitle-2 font-weight-bold" ></v-text-field>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.cancer" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.parasite" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <v-text-field v-model="form.allergies" readonly dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
                                                                <td>
                                                                    <v-text-field dense class="subtitle-2 font-weight-bold"></v-text-field>
                                                                </td>
...
export default {
    ...
    computed:{
        ...mapGetters(['allSalivaInfections']),
    },
    methods:{
        ...mapActions(['fetchSalivaInfections']),
